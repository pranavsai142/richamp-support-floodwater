...
python generateGraphs.py --stations OBS_STATIONS.json --gfsExists true --wind ../ObservationalWind/scenario_wind/testSandySEStart.nc --backgroundChoice SOUTH_RHODE_ISLAND
