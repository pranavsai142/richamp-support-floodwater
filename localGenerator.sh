...
# --generateRunup true \
# --tempDir /scratch3/workspace/pranav_sai_uri_edu-runup/dec2022_runup_slope_temp/ --backgroundChoice NAPATREE --graphDirectory Runup2022Slope/
...
# --meshExists true --mesh /scratch3/workspace/pranav_sai_uri_edu-runup/Dec172023RunupRun/forecast_RI_track/fort.14 \
# --generateRunup true \
# --tempDir /scratch3/workspace/pranav_sai_uri_edu-runup/dec2023_runup_slope_temp/ --backgroundChoice NAPATREE --graphDirectory Runup2023Slope/
...
python generateGraphs.py --stations OBS_STATIONS.json --waterExists true --water /project/pi_iginis_uri_edu/pranav_sai_uri_edu/RICHAMPFilesHenriAdvisory19_1m/RICHAMP_fort63.nc --tempDir /scratch3/workspace/pranav_sai_uri_edu-runup/temp/ --backgroundChoice NAPATREE --graphDirectory HenriObsWaterAdvisory19/
