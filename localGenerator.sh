...
# --generateRunup true \
# --tempDir /scratch3/workspace/pranav_sai_uri_edu-runup/dec2022_runup_temp/ --backgroundChoice NAPATREE --graphDirectory Runup2022Hard/
...
--meshExists true --mesh /scratch3/workspace/pranav_sai_uri_edu-runup/Dec172023RunupRun/forecast_RI_track/fort.14 \
--generateRunup true \
--tempDir /scratch3/workspace/pranav_sai_uri_edu-runup/dec2023_runup_profile_temp/ --backgroundChoice NAPATREE --graphDirectory Runup2023Profile/
