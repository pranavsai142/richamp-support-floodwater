...
python generateGraphs.py --stations OBS_STATIONS.json --gfsExists true --wind ../ObservationalWind/scenario_wind/testSandySEStart.nc --backgroundChoice RHODE_ISLAND_CHAMP
